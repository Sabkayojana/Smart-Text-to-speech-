...
export const ArrowPathIcon: React.FC<{ className?: string }> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.18-3.185m-3.181 9.348c-3.236 0-6.213-.896-8.73-2.522m11.664-11.664c-2.517-1.626-5.494-2.522-8.73-2.522S4.735 3.511 2.218 5.136m11.664 11.664v4.992" />
    </svg>
);
